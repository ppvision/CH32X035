...
#define FLASH_SELECT_PORT GPIOB
#define FLASH_SELECT_PIN  GPIO_Pin_3
#else
#define FLASH_SELECT_PORT GPIOA
...
void SPI_Flash_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = FLASH_SELECT_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(FLASH_SELECT_PORT, &GPIO_InitStructure);
    GPIO_SetBits(FLASH_SELECT_PORT, FLASH_SELECT_PIN);
...
u8 SPI_Flash_ReadSR(void)
{
    ...
    GPIO_WriteBit(FLASH_SELECT_PORT, FLASH_SELECT_PIN, 0);
    SPI1_ReadWriteByte(W25X_ReadStatusReg);
    byte = SPI1_ReadWriteByte(0Xff);
    GPIO_WriteBit(FLASH_SELECT_PORT, FLASH_SELECT_PIN, 1);
...
int flash_test(void)
{
    ...
    switch(Flash_Model)
    {
        ...
        case W25Q128:
            printf("Found W25Q128 OK! !!!\r\n");

            break;

        default:
            printf("xxxxxxxxxxFail!xxxxxxxxxx\r\n");
    ...
    printf("W25Qxx Write '%s' Finished!\r\n",TEXT_Buf);
    Delay_Ms(500);
    printf("Start Read W25Qxx....>>");
    SPI_Flash_Read(datap, 0x0, SIZE);
    printf("%s\r\n", datap);
